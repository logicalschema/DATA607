...
I was not able to reach a conclusion with regards to finding a causal relationship between recessions and license data. There were only two recessions within the scope of the Open NYC Data. In the future, I would like to cross reference minority owned businesses and borough. I did enjoy learning how to use Shiny but was unable to reach conclusive observations about the data.
