...
```{r bayes}
# Get Training Set
training_dfm <- dfm(training_corpus, remove = stopwords("english"))

# Get Test Set (documents not in id_train)
test_dfm <- dfm(testing_corpus, remove = stopwords("english"))

# Train the Bayes classifier
tmod_nb <- textmodel_nb(training_dfm, training_dfm$type)
summary(tmod_nb)
